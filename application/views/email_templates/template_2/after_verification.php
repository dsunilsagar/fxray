                    ...
                    <td class="w580" width="580" id="content-column">
                        ...
                        <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                            <tbody><tr>
                                    <td class="w580" width="580">
                                        <p align="left" class="article-title" style="font-size: 18px; line-height:24px; color: #b0b0b0; font-weight:bold; margin-top:0px; margin-bottom:18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif;">Welcome to XM</p>
                                    ...
                                    <td class="w640" width="640" height="60" style=" font-weight:bold;border:1px solid #D8D2D2; border-radius:8px;font-size:11px;font-family:arial;color:rgb(35,35,35);background:none repeat scroll 0% 0% rgb(227,227,227); padding: 10px;">
                                        ...
                                        <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                                            <tbody><tr>
                                                    ...
                                                    <td width="20"></td>
                                                    <td class="w180" width="80" valign="top">
                                                        <table class="w180" width="180" cellpadding="0" cellspacing="0" border="0">
                                                            <tbody>
                                                                <tr><td class="w180" width="180" height="10"></td></tr>
                                                                <tr>
                                                                    <td class="w180" width="180">
                                                                        <div align="left" class="article-content" style="font-size: 13px; line-height: 18px; color: #444444; margin-top: 0px; margin-bottom: 18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif;">
                                                                            <p>
                                                                                ...
                                                                                <br/>
                                                                                <i style="font-size: 11px; font-weight: normal;">*All data is case sensitive.</i>
                                                                            </p>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                        ...
                        <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                            <tbody>
                                <tr>
                                    <td class="w580" width="580">
                                        <p align="left" class="article-title" style="font-size: 18px; line-height:24px; color: #b0b0b0; font-weight:bold; margin-top:0px; margin-bottom:18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif;"><span style="border: 1px solid #000; background: #ccc;  color: #000;  -webkit-border-radius: 21px;  -moz-border-radius: 21px; border-radius: 21px; padding: 3px 9px; margin-right: 10px;">1</span>Download And Install Our Trading Platform</p>
                                        <div align="left" class="article-content" style="font-size: 13px; line-height: 18px; color: #444444; margin-top: 0px; margin-bottom: 18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif;">
                                            <p>To start trading immediately, first you need to download the XM platform, which is easy to use and can be installed on your PC within a few minutes.</p>
                                            <p>
                        ...
                        <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                            <tbody>
                                <tr>
                                    <td class="w580" width="580">
                                        <p align="left" class="article-title" style="font-size: 18px; line-height:24px; color: #b0b0b0; font-weight:bold; margin-top:0px; margin-bottom:18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif;"><span style="border: 1px solid #000; background: #ccc;  color: #000;  -webkit-border-radius: 21px;  -moz-border-radius: 21px; border-radius: 21px; padding: 3px 9px; margin-right: 10px;">2</span>
                                            Login To Your Trading Account
                                        </p>
                                        <div align="left" class="article-content" style="font-size: 13px; line-height: 18px; color: #444444; margin-top: 0px; margin-bottom: 18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif;">
                                            <p>
                                                Now open the ForexRay Metatrader platform on your PC, enter your login and password in the small login window fields, and make sure to select ForexRay Metatrader-Real for server, then click the Login button. 
                                            </p>
                                            <p>
                                        ...
                                        <table class="w180" width="180" cellpadding="0" cellspacing="0" border="0">
                                            <tbody><tr>
                                                ...
                                                <tr>
                                                    <td class="w180" width="180">
                                                        <div align="left" class="article-content" style="font-size: 13px; line-height: 18px; color: #444444; margin-top: 0px; margin-bottom: 18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif;">
                                                            <p>For trading at forexray online <a href="<?php echo site_url('login'); ?>" class="article-content-a" style="color: #2f82de; font-weight:bold; text-decoration:none;">Click Here</a> and login.</p>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr><td class="w180" width="180" height="10"></td></tr>
